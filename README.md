...
- 🌱 Изучаю Python. Рассматриваю Rust в качестве второго языка для изучения. Разумеется, одновременно с языками я осваиваю так же сопутствующие современные инструменты разработчика, которые могут мне понадобиться либо являются интересными.
